...
void main()
{
	//initialize the strings, constant charcters,and loop
	string pigLatinInput;
	string beginReversal;
	string endReversal;
	const char Ay = 'A', Eh = 'E', Ie = 'I', Oh = 'O', Uh = 'U', waY = 'Y', aY = 'a', eH = 'e', iE = 'i', oH = 'o', uH = 'u', WAy = 'y';
	...
	while (loop != 0)
	{
		...
		if (pigLatinInput[0] == one || pigLatinInput[0] == two || pigLatinInput[0] == three || pigLatinInput[0] == four || pigLatinInput[0] == five || pigLatinInput[0] == six ||
